...
{
    /// <inheritdoc />
    public partial class OrderSalesFullSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductStockCaches",
                columns: table => new
                {
                    ProductStockCacheId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ProductCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ProductName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductStockCaches", x => x.ProductStockCacheId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStockCaches_ProductId",
